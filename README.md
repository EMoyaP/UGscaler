...
La version actual es `1.1.0` y el APK esta en la raiz como [`UGscaler-v1.1.0.apk`](UGscaler-v1.1.0.apk).
...
El APK se genera en `app/build/outputs/apk/debug/UGscaler-v1.1.0.apk`.
