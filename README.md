...
La salida se genera en `app/build/outputs/apk/release/UGscaler-v1.6.4.apk` y la versión distribuible se copia a la raíz como `UGscaler-v1.6.4.apk`, sin `debug` en el nombre.
